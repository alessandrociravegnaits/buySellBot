...
def place_trailing_stop_order(
	...
	"""Invia un ordine STOP_LOSS con trailingDelta su Binance.
	...
	Args:
		...
		side: Lato ordine (BUY o SELL).
		quantity: Quantita' da ordinare.
		trailing_delta: Delta trailing Binance in BIPS.
	...
	if quantity <= 0:
		raise BinanceOrderValidationError("Quantity deve essere maggiore di zero.")
	if trailing_delta <= 0:
		raise BinanceOrderValidationError("Trailing delta deve essere maggiore di zero.")
